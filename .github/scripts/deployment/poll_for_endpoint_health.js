...
import smokeConsoleTestnet, { consolePath as testnetConsolePath } from '../../../config/console-smoke-testnet.js'
import smokeConsoleMainnet, { consolePath as mainnetConsolePath } from '../../../config/console-smoke-mainnet.js'
...
const endpointUrl = networkArg === 'testnet' ? testnetConsolePath : mainnetConsolePath
