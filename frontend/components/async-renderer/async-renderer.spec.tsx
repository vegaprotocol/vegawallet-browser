...
describe('AsyncRenderer', () => {
  it('should render loading content when loading is true', () => {
    render(<AsyncRenderer render={() => <div>Content</div>} loading renderLoading={() => <div>Loading...</div>} />)
  ...
  it('should render no data content when noData is true', () => {
    render(
      <AsyncRenderer render={() => <div>Content</div>} noData renderNoData={() => <div>No data available.</div>} />
    )
  ...
  it('should not render loading content when loading is false', () => {
    render(<AsyncRenderer render={() => <div>Content</div>} renderLoading={() => <div>Loading...'</div>} />)
