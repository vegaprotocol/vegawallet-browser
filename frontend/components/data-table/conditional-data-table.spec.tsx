...
describe('ConditionalDataTable', () => {
  it('should render components where data is defined', () => {
    ...
    render(<ConditionalDataTable items={rows} data={{ foo: 'foo', bar: null }} />)
  ...
  it('should not render for null, undefined, empty string', () => {
    ...
    render(<ConditionalDataTable items={rows} data={{ foo: 'foo', bar: undefined }} />)
    expect(screen.queryByText('bar')).not.toBeInTheDocument()

    render(<ConditionalDataTable items={rows} data={{ foo: 'foo', bar: '' }} />)
    expect(screen.queryByText('bar')).not.toBeInTheDocument()

    render(<ConditionalDataTable items={rows} data={{ foo: 'foo', bar: 'bar' }} />)
