...
describe('ArbitrumKey', () => {
  it('renders Arbitrum address correctly', () => {
    ...
    expect(screen.getByTestId(locators.title)).toHaveTextContent('Arbitrum Address')
    expect(explorerLink).toHaveAttribute('href', `https://sepolia.arbiscan.io/address/${address}`)
