...
describe('OrderTable', () => {
  ...
  it('displays "market price" for market order types', () => {
    render(<OrderTable price="100" type={OrderType.TYPE_MARKET} marketId="1" />)
  ...
  it('displays price for non-zero prices in non-market orders', () => {
    render(<OrderTable price="100" type={OrderType.TYPE_LIMIT} marketId="1" />)
  ...
  it('does not display price for zero prices in non-market orders', () => {
    render(<OrderTable price="0" type={OrderType.TYPE_LIMIT} marketId="1" />)
