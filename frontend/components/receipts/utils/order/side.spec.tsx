...
describe('DerivativeSide', () => {
  const renderComponent = (side: vegaSide) => render(<DerivativeSide side={side} />)
...
describe('OrderSide', () => {
  const renderComponent = (side: vegaSide, marketId: string) => render(<OrderSide side={side} marketId={marketId} />)
