...
describe('TransactionModal', () => {
  ...
  it('renders page header, transaction type, hostname and key', () => {
    /* 1101-BWAL-056 For transactions that are not orders or withdraw / transfers, there is a standard template with the minimum information required i.e. 
-- [ ] Transaction title
...
-- [ ] Raw JSON details
    ...
    1101-BWAL-057 I can copy the raw json to my clipboard
*/
    const handleTransactionDecision = jest.fn()
    ;(useModalStore as unknown as jest.Mock).mockImplementation((fn) => {
