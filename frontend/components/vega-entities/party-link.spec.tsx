...
describe('PartyLink', () => {
  it('renders truncated id and link', () => {
    ...
    renderComponent({ id })
    expect(screen.getByTestId(locators.partyLink)).toHaveTextContent('111111…1111')
    expect(screen.getByTestId(locators.partyLink)).toHaveAttribute('href', `${fairground.explorer}/parties/${id}`)
  })
