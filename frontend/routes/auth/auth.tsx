...
export const Auth = () => {
  ...
  // Connections store
  const { loading: loadingConnections, loadConnections } = useConnectionStore((state) => ({
    loading: state.loading,
  ...
  }, [loadingConnections, loadAssets, loadMarkets, loadingNetworks, loadingWallets, network.id, request])
