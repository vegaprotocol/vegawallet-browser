...
import { ExportRecoveryPhraseForm, locators } from './export-recovery-phrase-form'
...
describe('ExportRecoveryPhraseForm', () => {
  ...
  it('calls onClose when close button is clicked', async () => {
    ...
    const closeButton = screen.getByTestId(locators.exportRecoveryPhraseFormModalClose)
