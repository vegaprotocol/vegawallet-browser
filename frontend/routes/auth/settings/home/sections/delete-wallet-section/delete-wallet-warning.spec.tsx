...
import { DeleteWalletWarning, DeleteWalletWarningProperties, locators } from './delete-wallet-warning'
...
const renderComponent = (properties: DeleteWalletWarningProperties = { onClose: jest.fn() }) => {
...
describe('DeleteWalletWarning', () => {
  ...
  it('closes the dialog when the close button is clicked', () => {
    ...
    const closeButton = screen.getByTestId(locators.deleteWalletWarningCloseButton)
  ...
  it('deletes the wallet and navigates away when wallet is deleted', async () => {
    ...
    fireEvent.click(checkbox)
    const continueButton = screen.getByTestId(locators.deleteWalletWarningContinueButton)
