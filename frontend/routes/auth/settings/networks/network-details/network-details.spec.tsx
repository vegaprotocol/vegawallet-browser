...
describe('NetworkDetails', () => {
  ...
  it('should render the details of the network in each section', () => {
    ...
    expect(within(colors).getByTestId(vegaSubHeaderLocators.subHeader)).toHaveTextContent('Color')
    expect(within(colors).getByTestId(locators.color)).toHaveTextContent(testingNetwork.color)
