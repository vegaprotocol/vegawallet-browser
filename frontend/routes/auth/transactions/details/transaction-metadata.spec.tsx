...
describe('TransactionMeta', () => {
  ...
  it('renders transaction state, subheader and all metadata', () => {
    ...
    expect(screen.getByTestId(locators.transactionMetadataNetwork)).toHaveAttribute(
      'href',
    ...
    expect(screen.getByTestId(locators.transactionMetadataNode)).toHaveAttribute('href', 'https://node.com')

    expect(screen.getByTestId(locators.transactionMetadataOrigin)).toHaveTextContent('https://foo.com')
    expect(screen.getByTestId(locators.transactionMetadataOrigin)).toHaveAttribute('href', 'https://foo.com')
