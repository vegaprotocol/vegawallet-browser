...
describe('ImportWallet', () => {
  ...
  it('after successfully importing a wallet it redirects to wallets page', async () => {
    ...
    await waitFor(() => expect(mockedUsedNavigate).toHaveBeenCalledWith(FULL_ROUTES.wallets), { timeout: 1200 })
  })
  ...
  it('requires mnemonic should be 24 words', async () => {
    ...
    const errorMessage = await screen.findByText('Recovery phrase must be 12, 15, 18, 21 or 24 words')
