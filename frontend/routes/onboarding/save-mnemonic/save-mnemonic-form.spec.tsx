...
import { FormFields, SaveMnemonicForm, locators } from './save-mnemonic-form'
...
describe('SaveMnemonicForm', () => {
  ...
  it('renders the form correctly', () => {
    render(<SaveMnemonicForm onSubmit={mockedOnSubmit} loading={false} disabled={false} />)
  ...
  it('disables inputs when disabled is true', async () => {
    render(<SaveMnemonicForm onSubmit={mockedOnSubmit} loading={false} disabled={true} />)
  ...
  it('disables inputs when loading is true', async () => {
    render(<SaveMnemonicForm onSubmit={mockedOnSubmit} loading={true} disabled={false} />)
    expect(screen.getByTestId('acceptedTerms')).toBeDisabled()
    expect(screen.getByTestId(locators.saveMnemonicButton)).toBeDisabled()
  })
})
