...
export enum ConditionOperator {
  UNSPECIFIED = <any>'OPERATOR_UNSPECIFIED',
  EQUALS = <any>'OPERATOR_EQUALS',
  GREATERTHAN = <any>'OPERATOR_GREATER_THAN',
  GREATERTHANOREQUAL = <any>'OPERATOR_GREATER_THAN_OR_EQUAL',
  LESSTHAN = <any>'OPERATOR_LESS_THAN',
  LESSTHANOREQUAL = <any>'OPERATOR_LESS_THAN_OR_EQUAL'
}
...
export enum MarketTradingMode {
  UNSPECIFIED = <any>'TRADING_MODE_UNSPECIFIED',
  CONTINUOUS = <any>'TRADING_MODE_CONTINUOUS',
  BATCHAUCTION = <any>'TRADING_MODE_BATCH_AUCTION',
  OPENINGAUCTION = <any>'TRADING_MODE_OPENING_AUCTION',
  MONITORINGAUCTION = <any>'TRADING_MODE_MONITORING_AUCTION',
  NOTRADING = <any>'TRADING_MODE_NO_TRADING',
  SUSPENDEDVIAGOVERNANCE = <any>'TRADING_MODE_SUSPENDED_VIA_GOVERNANCE'
}
...
export enum V1PropertyKeyType {
  ...
  EMPTY = <any>'TYPE_EMPTY',
  INTEGER = <any>'TYPE_INTEGER',
  STRING = <any>'TYPE_STRING',
  BOOLEAN = <any>'TYPE_BOOLEAN',
  DECIMAL = <any>'TYPE_DECIMAL',
  TIMESTAMP = <any>'TYPE_TIMESTAMP'
}
/**
...
export enum V1StakeLinkingStatus {
  UNSPECIFIED = <any>'STATUS_UNSPECIFIED',
  PENDING = <any>'STATUS_PENDING',
  ACCEPTED = <any>'STATUS_ACCEPTED',
  REJECTED = <any>'STATUS_REJECTED'
}
/**
 *
 * @export
...
export enum VegaAccountType {
  ...
  INSURANCE = <any>'ACCOUNT_TYPE_INSURANCE',
  SETTLEMENT = <any>'ACCOUNT_TYPE_SETTLEMENT',
  MARGIN = <any>'ACCOUNT_TYPE_MARGIN',
  GENERAL = <any>'ACCOUNT_TYPE_GENERAL',
  FEESINFRASTRUCTURE = <any>'ACCOUNT_TYPE_FEES_INFRASTRUCTURE',
  FEESLIQUIDITY = <any>'ACCOUNT_TYPE_FEES_LIQUIDITY',
  FEESMAKER = <any>'ACCOUNT_TYPE_FEES_MAKER',
  BOND = <any>'ACCOUNT_TYPE_BOND',
  EXTERNAL = <any>'ACCOUNT_TYPE_EXTERNAL',
  GLOBALINSURANCE = <any>'ACCOUNT_TYPE_GLOBAL_INSURANCE',
  GLOBALREWARD = <any>'ACCOUNT_TYPE_GLOBAL_REWARD',
  PENDINGTRANSFERS = <any>'ACCOUNT_TYPE_PENDING_TRANSFERS',
  REWARDMAKERPAIDFEES = <any>'ACCOUNT_TYPE_REWARD_MAKER_PAID_FEES',
  REWARDMAKERRECEIVEDFEES = <any>'ACCOUNT_TYPE_REWARD_MAKER_RECEIVED_FEES',
  REWARDLPRECEIVEDFEES = <any>'ACCOUNT_TYPE_REWARD_LP_RECEIVED_FEES',
  REWARDMARKETPROPOSERS = <any>'ACCOUNT_TYPE_REWARD_MARKET_PROPOSERS',
  HOLDING = <any>'ACCOUNT_TYPE_HOLDING',
  LPLIQUIDITYFEES = <any>'ACCOUNT_TYPE_LP_LIQUIDITY_FEES',
  LIQUIDITYFEESBONUSDISTRIBUTION = <any>'ACCOUNT_TYPE_LIQUIDITY_FEES_BONUS_DISTRIBUTION',
  NETWORKTREASURY = <any>'ACCOUNT_TYPE_NETWORK_TREASURY',
  VESTINGREWARDS = <any>'ACCOUNT_TYPE_VESTING_REWARDS',
  VESTEDREWARDS = <any>'ACCOUNT_TYPE_VESTED_REWARDS',
  REWARDAVERAGEPOSITION = <any>'ACCOUNT_TYPE_REWARD_AVERAGE_POSITION',
  REWARDRELATIVERETURN = <any>'ACCOUNT_TYPE_REWARD_RELATIVE_RETURN',
  REWARDRETURNVOLATILITY = <any>'ACCOUNT_TYPE_REWARD_RETURN_VOLATILITY',
  REWARDVALIDATORRANKING = <any>'ACCOUNT_TYPE_REWARD_VALIDATOR_RANKING',
  PENDINGFEEREFERRALREWARD = <any>'ACCOUNT_TYPE_PENDING_FEE_REFERRAL_REWARD'
}
/**
 *
 * @export
...
export enum VegaAssetStatus {
  UNSPECIFIED = <any>'STATUS_UNSPECIFIED',
  PROPOSED = <any>'STATUS_PROPOSED',
  REJECTED = <any>'STATUS_REJECTED',
  PENDINGLISTING = <any>'STATUS_PENDING_LISTING',
  ENABLED = <any>'STATUS_ENABLED'
}
/**
 *
 * @export
...
export enum VegaAuctionTrigger {
  UNSPECIFIED = <any>'AUCTION_TRIGGER_UNSPECIFIED',
  BATCH = <any>'AUCTION_TRIGGER_BATCH',
  OPENING = <any>'AUCTION_TRIGGER_OPENING',
  PRICE = <any>'AUCTION_TRIGGER_PRICE',
  LIQUIDITY = <any>'AUCTION_TRIGGER_LIQUIDITY',
  LIQUIDITYTARGETNOTMET = <any>'AUCTION_TRIGGER_LIQUIDITY_TARGET_NOT_MET',
  UNABLETODEPLOYLPORDERS = <any>'AUCTION_TRIGGER_UNABLE_TO_DEPLOY_LP_ORDERS',
  GOVERNANCESUSPENSION = <any>'AUCTION_TRIGGER_GOVERNANCE_SUSPENSION'
}
/**
 *
 * @export
...
export enum VegaDataSourceSpecStatus {
  UNSPECIFIED = <any>'STATUS_UNSPECIFIED',
  ACTIVE = <any>'STATUS_ACTIVE',
  DEACTIVATED = <any>'STATUS_DEACTIVATED'
}
/**
 *
 * @export
...
export enum VegaDispatchMetric {
  UNSPECIFIED = <any>'DISPATCH_METRIC_UNSPECIFIED',
  MAKERFEESPAID = <any>'DISPATCH_METRIC_MAKER_FEES_PAID',
  MAKERFEESRECEIVED = <any>'DISPATCH_METRIC_MAKER_FEES_RECEIVED',
  LPFEESRECEIVED = <any>'DISPATCH_METRIC_LP_FEES_RECEIVED',
  MARKETVALUE = <any>'DISPATCH_METRIC_MARKET_VALUE',
  AVERAGEPOSITION = <any>'DISPATCH_METRIC_AVERAGE_POSITION',
  RELATIVERETURN = <any>'DISPATCH_METRIC_RELATIVE_RETURN',
  RETURNVOLATILITY = <any>'DISPATCH_METRIC_RETURN_VOLATILITY',
  VALIDATORRANKING = <any>'DISPATCH_METRIC_VALIDATOR_RANKING'
}
/**
 *
 * @export
...
export enum VegaDistributionStrategy {
  UNSPECIFIED = <any>'DISTRIBUTION_STRATEGY_UNSPECIFIED',
  PRORATA = <any>'DISTRIBUTION_STRATEGY_PRO_RATA',
  RANK = <any>'DISTRIBUTION_STRATEGY_RANK'
}
/**
 *
 * @export
...
export enum VegaEntityScope {
  UNSPECIFIED = <any>'ENTITY_SCOPE_UNSPECIFIED',
  INDIVIDUALS = <any>'ENTITY_SCOPE_INDIVIDUALS',
  TEAMS = <any>'ENTITY_SCOPE_TEAMS'
}
/**
...
export enum VegaGovernanceTransferType {
  UNSPECIFIED = <any>'GOVERNANCE_TRANSFER_TYPE_UNSPECIFIED',
  ALLORNOTHING = <any>'GOVERNANCE_TRANSFER_TYPE_ALL_OR_NOTHING',
  BESTEFFORT = <any>'GOVERNANCE_TRANSFER_TYPE_BEST_EFFORT'
}
/**
...
export enum VegaIndividualScope {
  UNSPECIFIED = <any>'INDIVIDUAL_SCOPE_UNSPECIFIED',
  ALL = <any>'INDIVIDUAL_SCOPE_ALL',
  INTEAM = <any>'INDIVIDUAL_SCOPE_IN_TEAM',
  NOTINTEAM = <any>'INDIVIDUAL_SCOPE_NOT_IN_TEAM'
}
/**
 *
 * @export
...
export enum VegaMarketState {
  ...
  PROPOSED = <any>'STATE_PROPOSED',
  REJECTED = <any>'STATE_REJECTED',
  PENDING = <any>'STATE_PENDING',
  CANCELLED = <any>'STATE_CANCELLED',
  ACTIVE = <any>'STATE_ACTIVE',
  SUSPENDED = <any>'STATE_SUSPENDED',
  CLOSED = <any>'STATE_CLOSED',
  TRADINGTERMINATED = <any>'STATE_TRADING_TERMINATED',
  SETTLED = <any>'STATE_SETTLED',
  SUSPENDEDVIAGOVERNANCE = <any>'STATE_SUSPENDED_VIA_GOVERNANCE'
}
/**
 *
 * @export
...
export enum VegaMarketStateUpdateType {
  UNSPECIFIED = <any>'MARKET_STATE_UPDATE_TYPE_UNSPECIFIED',
  TERMINATE = <any>'MARKET_STATE_UPDATE_TYPE_TERMINATE',
  SUSPEND = <any>'MARKET_STATE_UPDATE_TYPE_SUSPEND',
  RESUME = <any>'MARKET_STATE_UPDATE_TYPE_RESUME'
}
/**
 *
 * @export
...
export enum VegaProposalError {
  UNSPECIFIED = <any>'PROPOSAL_ERROR_UNSPECIFIED',
  CLOSETIMETOOSOON = <any>'PROPOSAL_ERROR_CLOSE_TIME_TOO_SOON',
  CLOSETIMETOOLATE = <any>'PROPOSAL_ERROR_CLOSE_TIME_TOO_LATE',
  ENACTTIMETOOSOON = <any>'PROPOSAL_ERROR_ENACT_TIME_TOO_SOON',
  ENACTTIMETOOLATE = <any>'PROPOSAL_ERROR_ENACT_TIME_TOO_LATE',
  INSUFFICIENTTOKENS = <any>'PROPOSAL_ERROR_INSUFFICIENT_TOKENS',
  INVALIDINSTRUMENTSECURITY = <any>'PROPOSAL_ERROR_INVALID_INSTRUMENT_SECURITY',
  NOPRODUCT = <any>'PROPOSAL_ERROR_NO_PRODUCT',
  UNSUPPORTEDPRODUCT = <any>'PROPOSAL_ERROR_UNSUPPORTED_PRODUCT',
  NOTRADINGMODE = <any>'PROPOSAL_ERROR_NO_TRADING_MODE',
  UNSUPPORTEDTRADINGMODE = <any>'PROPOSAL_ERROR_UNSUPPORTED_TRADING_MODE',
  NODEVALIDATIONFAILED = <any>'PROPOSAL_ERROR_NODE_VALIDATION_FAILED',
  MISSINGBUILTINASSETFIELD = <any>'PROPOSAL_ERROR_MISSING_BUILTIN_ASSET_FIELD',
  MISSINGERC20CONTRACTADDRESS = <any>'PROPOSAL_ERROR_MISSING_ERC20_CONTRACT_ADDRESS',
  INVALIDASSET = <any>'PROPOSAL_ERROR_INVALID_ASSET',
  INCOMPATIBLETIMESTAMPS = <any>'PROPOSAL_ERROR_INCOMPATIBLE_TIMESTAMPS',
  NORISKPARAMETERS = <any>'PROPOSAL_ERROR_NO_RISK_PARAMETERS',
  NETWORKPARAMETERINVALIDKEY = <any>'PROPOSAL_ERROR_NETWORK_PARAMETER_INVALID_KEY',
  NETWORKPARAMETERINVALIDVALUE = <any>'PROPOSAL_ERROR_NETWORK_PARAMETER_INVALID_VALUE',
  NETWORKPARAMETERVALIDATIONFAILED = <any>'PROPOSAL_ERROR_NETWORK_PARAMETER_VALIDATION_FAILED',
  OPENINGAUCTIONDURATIONTOOSMALL = <any>'PROPOSAL_ERROR_OPENING_AUCTION_DURATION_TOO_SMALL',
  OPENINGAUCTIONDURATIONTOOLARGE = <any>'PROPOSAL_ERROR_OPENING_AUCTION_DURATION_TOO_LARGE',
  COULDNOTINSTANTIATEMARKET = <any>'PROPOSAL_ERROR_COULD_NOT_INSTANTIATE_MARKET',
  INVALIDFUTUREPRODUCT = <any>'PROPOSAL_ERROR_INVALID_FUTURE_PRODUCT',
  INVALIDRISKPARAMETER = <any>'PROPOSAL_ERROR_INVALID_RISK_PARAMETER',
  MAJORITYTHRESHOLDNOTREACHED = <any>'PROPOSAL_ERROR_MAJORITY_THRESHOLD_NOT_REACHED',
  PARTICIPATIONTHRESHOLDNOTREACHED = <any>'PROPOSAL_ERROR_PARTICIPATION_THRESHOLD_NOT_REACHED',
  INVALIDASSETDETAILS = <any>'PROPOSAL_ERROR_INVALID_ASSET_DETAILS',
  UNKNOWNTYPE = <any>'PROPOSAL_ERROR_UNKNOWN_TYPE',
  UNKNOWNRISKPARAMETERTYPE = <any>'PROPOSAL_ERROR_UNKNOWN_RISK_PARAMETER_TYPE',
  INVALIDFREEFORM = <any>'PROPOSAL_ERROR_INVALID_FREEFORM',
  INSUFFICIENTEQUITYLIKESHARE = <any>'PROPOSAL_ERROR_INSUFFICIENT_EQUITY_LIKE_SHARE',
  INVALIDMARKET = <any>'PROPOSAL_ERROR_INVALID_MARKET',
  TOOMANYMARKETDECIMALPLACES = <any>'PROPOSAL_ERROR_TOO_MANY_MARKET_DECIMAL_PLACES',
  TOOMANYPRICEMONITORINGTRIGGERS = <any>'PROPOSAL_ERROR_TOO_MANY_PRICE_MONITORING_TRIGGERS',
  ERC20ADDRESSALREADYINUSE = <any>'PROPOSAL_ERROR_ERC20_ADDRESS_ALREADY_IN_USE',
  LPPRICERANGENONPOSITIVE = <any>'PROPOSAL_ERROR_LP_PRICE_RANGE_NONPOSITIVE',
  LPPRICERANGETOOLARGE = <any>'PROPOSAL_ERROR_LP_PRICE_RANGE_TOO_LARGE',
  LINEARSLIPPAGEFACTOROUTOFRANGE = <any>'PROPOSAL_ERROR_LINEAR_SLIPPAGE_FACTOR_OUT_OF_RANGE',
  QUADRATICSLIPPAGEFACTOROUTOFRANGE = <any>'PROPOSAL_ERROR_QUADRATIC_SLIPPAGE_FACTOR_OUT_OF_RANGE',
  INVALIDSPOT = <any>'PROPOSAL_ERROR_INVALID_SPOT',
  SPOTPRODUCTDISABLED = <any>'PROPOSAL_ERROR_SPOT_PRODUCT_DISABLED',
  INVALIDSUCCESSORMARKET = <any>'PROPOSAL_ERROR_INVALID_SUCCESSOR_MARKET',
  GOVERNANCETRANSFERPROPOSALFAILED = <any>'PROPOSAL_ERROR_GOVERNANCE_TRANSFER_PROPOSAL_FAILED',
  GOVERNANCETRANSFERPROPOSALINVALID = <any>'PROPOSAL_ERROR_GOVERNANCE_TRANSFER_PROPOSAL_INVALID',
  GOVERNANCECANCELTRANSFERPROPOSALINVALID = <any>'PROPOSAL_ERROR_GOVERNANCE_CANCEL_TRANSFER_PROPOSAL_INVALID',
  INVALIDMARKETSTATEUPDATE = <any>'PROPOSAL_ERROR_INVALID_MARKET_STATE_UPDATE',
  INVALIDSLAPARAMS = <any>'PROPOSAL_ERROR_INVALID_SLA_PARAMS',
  MISSINGSLAPARAMS = <any>'PROPOSAL_ERROR_MISSING_SLA_PARAMS',
  INVALIDPERPETUALPRODUCT = <any>'PROPOSAL_ERROR_INVALID_PERPETUAL_PRODUCT',
  INVALIDREFERRALPROGRAM = <any>'PROPOSAL_ERROR_INVALID_REFERRAL_PROGRAM',
  INVALIDVOLUMEDISCOUNTPROGRAM = <any>'PROPOSAL_ERROR_INVALID_VOLUME_DISCOUNT_PROGRAM'
}
/**
...
export enum VegaProposalState {
  UNSPECIFIED = <any>'STATE_UNSPECIFIED',
  FAILED = <any>'STATE_FAILED',
  OPEN = <any>'STATE_OPEN',
  PASSED = <any>'STATE_PASSED',
  REJECTED = <any>'STATE_REJECTED',
  DECLINED = <any>'STATE_DECLINED',
  ENACTED = <any>'STATE_ENACTED',
  WAITINGFORNODEVOTE = <any>'STATE_WAITING_FOR_NODE_VOTE'
}
/**
 *
 * @export
...
export enum VegaVoteValue {
  UNSPECIFIED = <any>'VALUE_UNSPECIFIED',
  NO = <any>'VALUE_NO',
  YES = <any>'VALUE_YES'
}
