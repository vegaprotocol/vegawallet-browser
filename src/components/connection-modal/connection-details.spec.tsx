...
//     render(<ConnectionDetails handleDecision={() => {}} isLoading={false} hostname="https://www.google.com" />)
...
//     render(<ConnectionDetails handleDecision={handleDecision} isLoading={false} hostname="https://www.google.com" />)
...
//     render(<ConnectionDetails handleDecision={() => {}} isLoading={true} hostname="https://www.google.com" />)
//     expect(screen.getByTestId(locators.connectionModalApproveButton)).toBeDisabled()
//     expect(screen.getByTestId(locators.connectionModalDenyButton)).toBeDisabled()
//   })
// })
