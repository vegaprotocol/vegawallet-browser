...
describe('Onboarding', () => {
  ...
  it('can create a new wallet and remember that a wallet has been created when I navigate back to the landing page', async () => {
    ...
    // 1101-BWAL-014 I can choose to create a wallet
    // 1101-BWAL-022 I am given feedback that my wallet was successfully created
    // 1101-BWAL-025 The new Wallet name and key pair are auto generated in the background "Wallet" "Vega Key 1" #
    // 1101-BWAL-026 When I have already created a wallet, I am redirected to the landing page where I can view that wallet
  ...
  it('can successfully import a wallet', async () => {
    // 1101-BWAL-015 I can choose to import an existing wallet
    // 1101-BWAL-074 I can choose to import an existing vega wallet TODO- remove duplicate AC from specs
    // 1101-BWAL-076 I can enter the recovery phrase to import my existing vega wallet
    // 1101-BWAL-077 I can submit the recovery phrase I have entered to import the wallet
    // 1101-BWAL-081 I am redirected to the next step
  ...
  it('recovery phrase can be revealed and hidden, cannot continue without revealing and acknowledging warning', async () => {
    // 1101-BWAL-016 - I am provided with a recovery phrase for my new wallet that is initially hidden from view
    // 1101-BWAL-018 - I can choose when to reveal/show the recovery phrase
    // 1101-BWAL-019 - I can copy the recovery phrase into my clipboard
    await password.createPassword()
    await createAWallet.createNewWallet()
